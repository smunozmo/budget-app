...
group_entity1 = GroupEntity.create({entity_id: entity1.id, amount: 32, group_id: group1.id})
group_entity2 = GroupEntity.create({entity_id: entity2.id, amount: 32, group_id: group1.id})
group_entity3 = GroupEntity.create({entity_id: entity3.id, amount: 32, group_id: group1.id})
group_entity4 = GroupEntity.create({entity_id: entity4.id, amount: 32, group_id: group1.id})
group_entity5 = GroupEntity.create({entity_id: entity5.id, amount: 32, group_id: group2.id})
group_entity6 = GroupEntity.create({entity_id: entity6.id, amount: 32, group_id: group2.id})
group_entity7 = GroupEntity.create({entity_id: entity7.id, amount: 32, group_id: group2.id})
group_entity8 = GroupEntity.create({entity_id: entity8.id, amount: 32, group_id: group2.id})
group_entity9 = GroupEntity.create({entity_id: entity1.id, amount: 32, group_id: group3.id})
group_entity10 = GroupEntity.create({entity_id: entity2.id, amount: 32, group_id: group4.id})